<?php
    ...
    class ProtectedMiniSiteUser extends DataObject
    {
        ...
        public function getPagesArray($ParentID, &$pagesArray, $level)
        {
        ...
        public static function CurrentSecureUser()
        {
    ...
    class ProtectedMiniSite_Controller extends Page_Controller
    {
        ...
        public function SecureLoginForm()
        {
        ...
        public function doProtectedPagesLogin($data, $form)
        {
